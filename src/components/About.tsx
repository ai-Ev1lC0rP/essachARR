      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-shr-primary to-shr-accent1 rounded-2xl p-8 md:p-12 text-center">
            ...
            <button className="inline-flex items-center justify-center px-8 py-3 rounded-lg bg-white text-shr-primary hover:bg-shr-secondary transition-all duration-300 font-medium">
              Contact Us
